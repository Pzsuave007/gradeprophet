          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <div className="grid grid-cols-2 gap-1.5 mt-2">
                <a href={`https://www.ebay.com/sch/i.html?_nkw=${encodeURIComponent([f.year, f.set_name, f.player, f.card_number ? '#' + f.card_number : '', f.is_graded && f.grading_company ? f.grading_company : '', f.is_graded && f.grade ? f.grade : ''].filter(Boolean).join(' '))}&_sacat=0&_from=R40&LH_Sold=1&rt=nc&LH_Complete=1`}
                ...
                <a href={`https://app.cardladder.com/sales-history?direction=desc&sort=date&q=${encodeURIComponent([f.year, f.set_name, f.player, f.card_number ? '#' + f.card_number : '', f.is_graded && f.grading_company ? f.grading_company : '', f.is_graded && f.grade ? f.grade : ''].filter(Boolean).join(' '))}`}
                  target="_blank" rel="noopener noreferrer"
