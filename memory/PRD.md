...
- **Thumbnail Generation on Create/Update (DONE)** — Inventory item create and update endpoints now automatically generate `thumbnail`, `store_thumbnail`, and `back_thumbnail` alongside the full-size images.
